...
export default function Testimonials() {
    ...
    const testimonials = [
        ...
        },
        {
            ...
            imageUrl: pessoa3,
            text: 
            '"A parceria com o Must foi uma das melhores decisões de minha carreira. A marca tem um forte reconhecimento, e o suporte contínuo me ajudou a administrar a operação com confiança. Hoje, nossa unidade está entre as mais lucrativas da região."',
        },
    ...
    return (
        <div className="testimonials padding-top" id='testimonials'>    
